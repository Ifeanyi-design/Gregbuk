            ...
            "subservices": [
                {
                    ...
                    "products": [
                        {"name": "Vinyl Banner",
                         ...
                         "image_url": "vynly-banner.jpeg", "category_name": "vinyl", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Fabric Banner",
                         "description": "Premium fabric banners with a professional finish and soft texture.",
                         "image_url": "fabric-banner.jpeg", "category_name": "fabric", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Mesh Banners", "description": "Wind-resistant mesh banners ideal for outdoor use.",
                         "image_url": "mesh-perforated-banner.webp", "category_name": "mesh", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "X Banner Stands",
                         "description": "Portable X-frame banners perfect for trade shows and events.",
                         "image_url": "x-stand.jpeg", "category_name": "x-banner", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Step & Repeat Banners",
                         "description": "Custom step-and-repeat banners for photo backdrops and branding.",
                         "image_url": "StepandRepeat.jpeg", "category_name": "step-repeat", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Pop Up Display",
                         "description": "Quick and easy pop-up banners for instant presentation setups.",
                         "image_url": "popup.jpeg", "category_name": "pop-up", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Tablecloths",
                         "description": "Branded table covers for events, trade shows, and promotions.",
                         "image_url": "tablecloth.jpeg", "category_name": "tbc", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Table Runners",
                         "description": "Custom table runners to complement your branded setup.",
                         "image_url": "table-runner.jpeg", "category_name": "T-run", "image_collection": [choice(imgg) for n in range(8)]}
                    ]
                },
                {
                    ...
                    "products": [
                        {"name": "Retractable Banner",
                         ...
                         "image_url": "retract.jpeg", "category_name": "retract", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Premium Retractable Banner",
                         "description": "High-quality retractable banner with premium print and finish.",
                         "image_url": "premium-retract.jpeg", "category_name": "premium-retract", "image_collection": [choice(imgg) for n in range(8)]},
                        ...
                        {"name": "Professional Retractable Banner",
                         ...
                         "image_url": "professional-retract.jpeg", "category_name": "pro-retract", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Black Retractable Banner",
                         "description": "Sleek black retractable banner for elegant event displays.",
                         "image_url": "RetractableBanner.jpeg", "category_name": "black-retract", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Double Sided Retractable Banner",
                         "description": "Displays your message on both sides for maximum exposure.",
                         "image_url": "DoubleSidedRetractableBannerStandcopy.webp", "category_name": "dbs-retract", "image_collection": [choice(imgg) for n in range(8)]}
                    ]
                },
                {
                    ...
                    "products": [
                        {"name": "Feather Flags",
                         ...
                         "image_url": "FeatherFlag.jpeg", "category_name": "f-flags", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Teardrop Flags",
                         "description": "Eye-catching teardrop-shaped flags for promotions and events.",
                         "image_url": "TeardropFlags.jpeg", "category_name": "t-flag", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Blade Flags",
                         "description": "Blade-style flags with bold graphics for maximum visibility.",
                         "image_url": "blade-flag.jpeg", "category_name": "b-flag", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Custom Flags",
                         "description": "Fully customizable flags tailored to your branding requirements.",
                         "image_url": "custumflag.jpeg", "category_name": "c-flag", "image_collection": [choice(imgg) for n in range(8)]}
                    ]
                }
            ]
        },
            ...
            "subservices": [
                {
                    ...
                    "products": [
                        {"name": "Company Seals",
                         ...
                         "image_url": "Company-seal1-1.png", "category_name": "company-seal", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Notary Seals",
                         "description": "Professional notary seals to validate legal documents.",
                         "image_url": "Notary-Seal.jpeg", "category_name": "notary-seal", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Embossed Seals", "description": "Elegant embossed seals for a sophisticated finish.",
                         "image_url": "embossed-seal.jpeg", "category_name": "embossed-seal", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Holographic Seals",
                         "description": "Secure holographic seals for brand protection and authenticity.",
                         "image_url": "holographic_seal.jpeg", "category_name": "holo-seal", "image_collection": [choice(imgg) for n in range(8)]},
                ...
                },
                {
                    ...
                    "products": [
                        {"name": "Signature Stamp",
                         ...
                         "image_url": "Signature-Stamp.jpeg", "category_name": "signature-stamp", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Rubber Stamp",
                         "description": "Traditional rubber stamps for official marking and branding.",
                         "image_url": "RubberStamps.jpeg", "category_name": "rubber-stamp", "image_collection": [choice(imgg) for n in range(8)]},
                        ...
                        {"name": "Pre-ink Stamp", "description": "Pre-inked stamps for crisp, consistent impressions.",
                         "image_url": "PreInkedStamp.jpeg", "category_name": "pre-ink-stamp", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Date Stamp",
                         "description": "Date stamps for tracking, labeling, or official documentation.",
                         "image_url": "date-stamp.jpeg", "category_name": "date-stamp", "image_collection": [choice(imgg) for n in range(8)]}
                    ]
                }
            ]
        },
            ...
            "subservices": [
                {
                    ...
                    "products": [
                        {"name": "Wood Frame",
                         ...
                         "image_url": "woodframe.jpg", "category_name": "wood-frames", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Metal Frame", "description": "Modern metal frames offering sleek and durable design.",
                         "image_url": "metal_frame.jpg", "category_name": "metal-frames", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Plastic Frame",
                         "description": "Affordable plastic frames in multiple colors and styles.",
                         "image_url": "plastic_frame.png", "category_name": "plastic-frames", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Glass Frame",
                         "description": "Glass frames with minimalistic design, perfect for modern interiors.",
                         "image_url": "glass-frame.jpg", "category_name": "glass-frames", "image_collection": [choice(imgg) for n in range(8)]}
                    ]
                },
                {
                    "name": "Plaques",
                    ...
                    "products": [
                        {"name": "Wood Plaques", "description": "Elegant wooden plaques for awards and recognitions.",
                         "image_url": "woodplaque.jpg", "category_name": "wood-plaques", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Metal Plaques",
                         "description": "Durable metal plaques for professional achievements and commemorations.",
                         "image_url": "metal_plaque.jpeg", "category_name": "metal-plaques", "image_collection": [choice(imgg) for n in range(8)]},
                        ...
                        {"name": "Glass Plaques",
                         ...
                         "image_url": "glass.webp", "category_name": "glass-plaques", "image_collection": [choice(imgg) for n in range(8)]},
                        {"name": "Crystal Plaques",
                         "description": "Luxury crystal plaques for top-tier awards and prestigious events.",
                         "image_url": "crstal_plaque.jpeg", "category_name": "crystal-plaques", "image_collection": [choice(imgg) for n in range(8)]}
                    ]
                }
            ]
        }
